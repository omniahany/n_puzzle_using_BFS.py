class State:
    ...
    def Manhattan_Distance(self ,n): 
        ...
        return( self.greedy_evaluation, self.Best_First_evaluation)
    ...
    def Misplaced_Tiles(self,n): 
        ...
        self.Best_First_evaluation = self.heuristic + self.cost

        return( self.Best_First_evaluation)
